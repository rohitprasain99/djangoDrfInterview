...
SECRET_KEY = 'django-insecure-dj6cfoy_z0%d^_s(ox%#^s4(q@3zv4$-@lvsvyesq11x*me7m%'
...
ROOT_URLCONF = 'djangoDrfInterview.urls'
...
WSGI_APPLICATION = 'djangoDrfInterview.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'workstuffrohit@gmail.com'  
